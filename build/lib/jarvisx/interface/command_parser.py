...
class CommandParser:
    COMMANDS = {
        ...
        "morning": "Generate unified morning briefing for Academics, Engineering, and Life",
        "study": "Activate 1-Click Study Mode, Pomodoro timer, distraction blocker",
        "coding-session": "Prepare autonomous coding session with restored workspace context",
        "brain": "Query unified brain across shared memory, schedule, and assignments",
        "graph": "Query relational Knowledge Graph for decisions, bugs, and concepts",
        "vision-agent": "Run Observe-Reason-Act-Verify UI agent loop",
        "proactive": "Proactively prepare assignment workspaces and templates",
        "notify": "Dispatch smart prioritized notification",
