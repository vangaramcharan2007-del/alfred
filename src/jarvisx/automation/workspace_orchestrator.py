...
WORKSPACE_PROFILES: Dict[str, WorkspaceProfile] = {
    "coding": WorkspaceProfile(
        ...
        speech_prompt="Setting up your engineering workspace right now, Charan.",
    ...
    "research": WorkspaceProfile(
        ...
        speech_prompt="Staging your research environment now, Charan.",
    ...
    "system_defense": WorkspaceProfile(
        ...
        apps=["taskmgr"],
        urls=[],
        speech_prompt="Engaging defensive telemetry and system security sweep, Charan.",
